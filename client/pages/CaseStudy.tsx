          ...
          <div ref={heroRef} className="relative z-10 text-center logo-hero">
            <div className="mb-8">
              <img
                ...
                className="mx-auto"
                style={{
                  height: caseStudy.id === 'abu-dawood' ? '200px' :
                          caseStudy.id === 'cream-stream' ? '150px' :
                          caseStudy.id === 'kiswa' ? '150px' :
                          caseStudy.id === 'electrech' ? '300px' :
                          caseStudy.id === 'aman-care' ? '80px' : '100px',
